...
namespace Niantic.ARDK.AR.Configuration
{
  ...
  internal sealed class _ARSessionChangesCollector
  {
    internal class _ARSessionRunProperties
    {
      public IARConfiguration ARConfiguration;
      public ARSessionRunOptions RunOptions;

      public _ARSessionRunProperties
      (
    ...
    private Action<_ARSessionRunProperties> _configChangesRequested;

    private bool _observerRequestedCollection;

    private IARConfiguration _preChangeConfiguration;

    internal _ARSessionChangesCollector(_IARSession arSession)
    {
    ...
    internal void _CollectChanges(IARConfiguration arConfiguration, ref ARSessionRunOptions runOptions)
    {
      ...
      var properties = new _ARSessionRunProperties(arConfiguration, runOptions);
