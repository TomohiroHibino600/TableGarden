...
namespace Niantic.ARDK.AR
{
    ...
    IAwarenessBufferProcessor
  {
    ...
    uint GetSemantics(int screenX, int screenY);
    ...
    int[] GetChannelIndicesAt(int screenX, int screenY);
    ...
    string[] GetChannelNamesAt(int screenX, int screenY);
    ...
    bool DoesChannelExistAt(int screenX, int screenY, int channelIndex);
    ...
    /// @returns True if the semantic channel exists at the given coordinates.
    bool DoesChannelExistAt(int screenX, int screenY, string channelName);
