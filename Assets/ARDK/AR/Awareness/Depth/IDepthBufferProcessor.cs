...
namespace Niantic.ARDK.AR.Awareness.Depth
{
    ...
    IAwarenessBufferProcessor
  {
    ...
    float GetDepth(int screenX, int screenY);
    ...
    float GetDistance(int screenX, int screenY);
    ...
    Vector3 GetWorldPosition(int screenX, int screenY);
    ...
    Vector3 GetSurfaceNormal(int screenX, int screenY);
